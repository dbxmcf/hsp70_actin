...
```python
$ python lf_csv2_dtype_h5.py sample_hsp70_actin
```

The above python script will convert the last step csv file () converted to an hdf5 file named sample_hsp70_actin.h5 to be used as the input file for the distributed version of the program.
