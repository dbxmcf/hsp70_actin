...
for AminoAcidName in aa_list:
    ...
    #Output_Folder_Path = f'/ddnA/work/wxx6941/TSR/code/code/Tarikul_code/Drug/{AminoAcidName.lower()}/output_receptor_level3_mirror_image'
    #Output_Folder_Path = f'./output_receptor_level3_mirror_image'
    Output_Folder_Path = f'./Negative_key'
    ...
    for i in range(len(PDB_list)):
        ...
        PDB_File_Path = "./original_pdb_hydrogen_removal/{}.pdb".format(
            PDB_ID)
