...
for AminoAcidName in aa_list:
    ...
    #Output_Folder_Path = f'/ddnA/work/wxx6941/TSR/code/code/Tarikul_code/Drug/{AminoAcidName.lower()}/output_receptor_level3'
    #Output_Folder_Path = f'./output_receptor_level3'
    Output_Folder_Path = f'./without_Negative_key'
