...
#data = np.arange(1,16,dtype=np.uint16).reshape(3,-1)
data = np.array([[1,0,3,0,5],[6,7,0,9,10],[11,0,13,14,0]])
print(data.shape)
print(data.dtype)
...
for i, c in enumerate(lst_cmb):
    ...
    #print("numerator_jac = ",numerator_jac)
    ...
    #print("numerator_gen_jac = ",numerator_gen_jac)
    #print("denomenator_gen_jac = ",denomenator_gen_jac)
    ...
    if (denomenator_jac == 0):
        ...
        print("denomenator_sarika = ",denomenator_sarika)
