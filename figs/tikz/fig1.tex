...
\foreach \idiv in {0,...,\nloop}
{
    ...
    \draw [decorate,line width=0.3mm,decoration={brace,amplitude=10pt}, yshift = 0cm]
...
(0,\pythagheight) --
(\pythagheight,\pythagheight) node [midway, above]{protein$_0$ to protein$_{N-1}$};

\draw
[line width=0.5mm,dotted,decoration={markings,mark=at position 1 with
    {\arrow[scale=2,>=stealth]{>}}},postaction={decorate}]
(\pythagheight,\pythagheight) --
(\pythagheight,0) node [midway,right, sloped,xshift=-2cm, yshift=0.3cm] {protein$_0$ to protein$_{N-1}$};

%\node [midway, right][label={[label distance=0.5cm,text depth=-1ex,rotate=-90]right:a long text}]
