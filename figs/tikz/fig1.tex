...
\draw [pattern=north east lines, pattern color=gray] (hltria) -- (hltrib) -- (hltric) -- (hltria);
...
row sep=0.05cm,column sep=0.05cm] (m) at (rrectctr) {
  (p_{m+1},p_{m+1}) & \cdots & (p_{2m+1},p_{m+1}) \\
  & \ddots & \vdots \\
  & & (p_{2m+1},p_{2m+1}) \\
      };
...
\matrix [matrix of math nodes,
row sep=0.05cm,column sep=0.05cm] (m) at (rrectctr) {
  (p_{3m+2},p_{2m+2}) & \cdots & (p_{4m+2},p_{2m+2}) \\
  \vdots & \ddots & \vdots \\
  (p_{3m+2},p_{3m+2}) & \cdots & (p_{4m+2},p_{3m+2}) \\
      };
