...
\foreach \idiv in {0,...,\nloop}
{
    ...
    \draw [decorate,line width=0.3mm,decoration={calligraphic brace,amplitude=10pt}, yshift = 0cm]
    ...
    \draw [decorate,,line width=0.3mm,decoration={calligraphic brace,amplitude=10pt,mirror}, yshift = 0cm]
